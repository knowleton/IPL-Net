...
def min_max_norm_2d_numpy(array: np.ndarray) -> np.ndarray:
    ...
    array = np.divide((array - arr_min) , (arr_max - arr_min))
...
class Dataset2D(nn.Module):
    def __init__(self, data_dir: str,  image_dir: str, mask_dir: str, index_list: list, is_train: bool = True, num_classes: int = 1, crop_size: Tuple[int] = (32, 224, 224),
                 norm: str = "zscore", dhw: Tuple[int] = (-1, 224, 224), is_keyframe: bool = True, is_softmax: bool = False, is_v3d: bool = False, is_flip: bool = False,window_min:int=-1000,window_max:int=1000) -> None:
    ...
    def __getitem__(self, index) -> Dict:
        ...
        img_array[img_array>self.window_max]=self.window_max
        img_array[img_array<self.window_min]=self.window_min        
...
class Dataset3D(nn.Module):
    def __init__(self, data_dir: str,  image_dir: str, mask_dir: str, index_list: list, is_train: bool = True, num_classes: int = 1,
                 crop_size: Tuple[int] = (32, 224, 224), norm: str = "zscore", dhw: Tuple[int] = (-1, 224, 224), is_keyframe: bool = True, is_softmax: bool = False, is_flip: bool = False,window_min:int=-1000,window_max:int=1000) -> None:
...
class Dataset2D_Predict(nn.Module):
    def __init__(self, data_dir: str,  image_dir: str, index_list: list, norm: str = "zscore", dhw: Tuple[int] = (-1, 224, 224), is_v3d: bool = False,window_min:int=-1000,window_max:int=1000) -> None:
...
class Dataset3D_Predict(nn.Module):
    def __init__(self, data_dir: str,  image_dir: str, index_list: list, norm: str = "zscore", dhw: Tuple[int] = (-1, 224, 224),window_min:int=-1000,window_max:int=1000) -> None:
