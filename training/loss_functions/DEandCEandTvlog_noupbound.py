...
import numpy as np
from nnunet.training.loss_functions.TverskylogNoupbound import TverskyLogLoss_noupbound
from nnunet.training.loss_functions.dice_loss import *

class DC_and_CE_and_TVLogloss_noupbound(nn.Module):
    #这里多加一个weight_trv
    def __init__(self, soft_dice_kwargs, ce_kwargs, aggregate="sum", square_dice=False, weight_ce=1, weight_dice=1,weight_trv=1,
        ...
        :param weight_dice:
        """
        super(DC_and_CE_and_TVLogloss_noupbound, self).__init__()
        ...
        # 我看CE也没啥参数，我就不加了
        self.trv=TverskyLogLoss_noupbound()
