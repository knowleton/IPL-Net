...
from nnunet.training.network_training.nnUNetTrainerV2_DCCETVloss import nnUNetTrainerV2_DCCETVloss
import time

        
class nnUNetTrainerV2_FLARE_Big_Tvr(nnUNetTrainerV2_DCCETVloss):
...
class nnUNetTrainerV2_FLARE_Small_Tvr(nnUNetTrainerV2_DCCETVloss):
    def initialize_network(self):
