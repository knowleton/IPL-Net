...
from nnunet.training.network_training.nnUNetTrainerV2_DCCETVLoglossNoUpbound import nnUNetTrainerV2_DCCETVLoglossNoUpbound
import time

        
class nnUNetTrainerV2_FLARE_Big_Tvr_log_noupbound(nnUNetTrainerV2_DCCETVLoglossNoUpbound):
...
class nnUNetTrainerV2_FLARE_Small_Tvr_log_noupbound(nnUNetTrainerV2_DCCETVLoglossNoUpbound):
    def initialize_network(self):
