...
from nnunet.training.network_training.nnUNetTrainerV2_DCCETVLogloss import nnUNetTrainerV2_DCCETVLogloss
import time

        
class nnUNetTrainerV2_FLARE_Big_Tvr_log(nnUNetTrainerV2_DCCETVLogloss):
...
class nnUNetTrainerV2_FLARE_Small_Tvr_log(nnUNetTrainerV2_DCCETVLogloss):
    def initialize_network(self):
